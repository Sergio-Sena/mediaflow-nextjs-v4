...
# 1. Desabilitar distribuição antiga
print("1. Desabilitando distribuicao antiga E1O4R8P5BGZTMW...")
...
print("   Distribuicao antiga desabilitada!")
print("   Aguardando 2 minutos para propagacao...")
time.sleep(120)
...
print(f"\nProximo passo: Atualizar README.md com novo ID: {dist_id}")
