...
print(f"\nAguarde 5-10 minutos para propagacao...")
print(f"\nProximos passos:")
print(f"   1. Aguardar status 'Deployed'")
print(f"   2. Atualizar README.md com novo ID: {dist_id}")
print(f"   3. Desabilitar distribuicao antiga: E1O4R8P5BGZTMW")
