...
export default function FileList({ onPlayVideo, onViewImage, onViewPDF, refreshTrigger, onFilesLoaded, targetFolder }: FileListProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="sticky top-[80px] sm:top-[95px] landscape:top-[60px] z-40 bg-dark-900/95 backdrop-blur-md border-b border-neon-cyan/10 px-3 sm:px-8 py-2 -mx-4 sm:-mx-8">
