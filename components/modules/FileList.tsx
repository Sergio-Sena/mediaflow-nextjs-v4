      ...
      <div className="sticky top-[80px] sm:top-[95px] landscape:top-[85px] z-40 bg-dark-900/95 backdrop-blur-md border-b border-neon-cyan/10 px-3 sm:px-8 py-2 -mx-4 sm:-mx-8">
        <div className="flex items-center gap-3">
          ...
          <select
            ...
            className="h-[36px] w-[44px] sm:w-auto sm:px-3 px-1 bg-gray-800 border border-gray-600 rounded-lg text-white text-sm focus:border-neon-cyan focus:outline-none flex-shrink-0"
          >
            <option value="">🚀</option>
