...
LOCAL_DIR = r'C:\Users\dell 5557\Videos\IDM\Corporativo\TUSHY'
S3_PREFIX = 'users/user_admin/Corporativo/TUSHY/'
...
def upload():
    ...
    print(f'UPLOAD TUSHY: {total} arquivos ({total_size / (1024**3):.2f} GB)')
    print('=' * 70)
