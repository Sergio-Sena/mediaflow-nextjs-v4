...
export default function PricingPage() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="max-w-7xl mx-auto px-4 py-8 sm:py-16 text-center">
        ...
        <div className="inline-flex items-center gap-2 glass-card px-3 sm:px-4 py-2 text-xs sm:text-sm">
          <span className="text-green-400">✓</span>
          <span className="hidden sm:inline">15 dias grátis • Sem cartão de crédito • Cancele quando quiser</span>
          <span className="sm:hidden">15 dias grátis • Sem cartão</span>
        </div>
      </section>
          ...
          {plans.map((plan) => (
            ...
            >
              ...
              <div className="text-center mb-4 sm:mb-6">
                ...
                <div className="text-2xl sm:text-3xl font-bold text-neon-cyan mb-1">
                  {plan.price}
                </div>
              ...
              <ul className="space-y-2 sm:space-y-3 mb-4 sm:mb-6">
                {plan.features.map((feature, i) => (
                  <li key={i} className="flex items-start gap-2 text-xs sm:text-sm">
                    <Check className="w-4 h-4 sm:w-5 sm:h-5 text-neon-cyan flex-shrink-0 mt-0.5" />
                    <span>{feature}</span>
                  </li>
                ))}
              </ul>
      ...
      <section className="max-w-4xl mx-auto px-4 pb-8 sm:pb-16">
        <div className="glass-card p-4 sm:p-8 border-2 border-green-500/30 bg-green-500/5">
      ...
      <section className="max-w-7xl mx-auto px-4 pb-8 sm:pb-16">
          ...
          <table className="w-full text-xs sm:text-sm min-w-[500px]">
            <thead>
              <tr className="border-b border-gray-700">
                <th className="text-left py-3 px-2 sm:px-4">Recurso</th>
                <th className="text-center py-3 px-2 sm:px-4">Mídiaflow</th>
                <th className="text-center py-3 px-2 sm:px-4">Vimeo</th>
                <th className="text-center py-3 px-2 sm:px-4">Wistia</th>
                <th className="text-center py-3 px-2 sm:px-4">YouTube</th>
              </tr>
            </thead>
            <tbody>
              <tr className="border-b border-gray-800">
                <td className="py-3 px-2 sm:px-4">Preço (50GB)</td>
              ...
              <tr className="border-b border-gray-800">
                <td className="py-3 px-2 sm:px-4">Conversão 4K</td>
              ...
              <tr className="border-b border-gray-800">
                <td className="py-3 px-2 sm:px-4">Sem anúncios</td>
                <td className="text-center text-green-400">✓</td>
                <td className="text-center text-green-400">✓</td>
                <td className="text-center text-green-400">✓</td>
                <td className="text-center text-red-400">✗</td>
              ...
              <tr className="border-b border-gray-800">
                <td className="py-3 px-2 sm:px-4">White-label</td>
              ...
              <tr className="border-b border-gray-800">
                <td className="py-3 px-2 sm:px-4">API Completa</td>
                <td className="text-center text-green-400">✓ Pro</td>
              ...
              <tr>
                <td className="py-3 px-2 sm:px-4">🎁 Storage de arquivos</td>
        ...
        <div className="grid sm:grid-cols-3 gap-4 sm:gap-6 mt-6 sm:mt-8">
          <div className="glass-card p-4 sm:p-6 text-center">
            ...
            <h3 className="text-sm sm:text-base font-bold mb-2">50% mais barato</h3>
            <p className="text-xs sm:text-sm text-gray-400">que Vimeo com mesmas features</p>
          </div>
          <div className="glass-card p-4 sm:p-6 text-center">
            <div className="text-2xl sm:text-3xl mb-2">🎁</div>
            <h3 className="text-sm sm:text-base font-bold mb-2">Storage bônus</h3>
            <p className="text-xs sm:text-sm text-gray-400">Armazene qualquer arquivo, não só vídeos</p>
          </div>
          <div className="glass-card p-4 sm:p-6 text-center">
            <div className="text-2xl sm:text-3xl mb-2">🚀</div>
            <h3 className="text-sm sm:text-base font-bold mb-2">CDN Global</h3>
        ...
        <div className="space-y-3 sm:space-y-4">
          {faqs.map((faq, i) => (
            <div key={i} className="glass-card p-4 sm:p-6">
              <h3 className="text-sm sm:text-base font-bold mb-2 text-neon-cyan">{faq.q}</h3>
      ...
      <section className="max-w-4xl mx-auto px-4 pb-8 sm:pb-16 text-center">
